...
par(las=2, cex=0.7)
boxplot(death ~ by_median, xaxt="n", ylab="30-day Death Rate", main="Heart Attack 30-day Death Rate by State")
tab <- table(by_median)
s <- names(tab)
axis(1, 1:length(s), paste0(s, " (", as.numeric(tab), ")"), las=2, cex.axis=0.8)